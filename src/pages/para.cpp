...
{
    // This file part is generated from ./pages/para.js
    pages[PAGE_PARA_JS] = R"=====(
...
{
    // This file part is generated from ./pages/para.html
    pages[PAGE_PARA_HTML] = R"=====(
<!doctype html>
