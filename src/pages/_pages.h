  ...
  <body onLoad="Init();">
    ...
    <div class="form"  >
      <div class="ligne">
        ...
        <label for='Proxy' style='text-align:right;'>ESP Externe</label>
        <input type='radio' name='sources' id='Proxy' value="Proxy"  onclick="checkDisabled();">
      </div>
    ...
    <div class="form"  >
      ...
      <div class='ligne' id="ligneEnphaseSerial">
        <label for='EnphaseSerial'>Numéro série passerelle IQ Enphase : <span class='fsize10'><br>Pour firmvare Envoy-S V7 seulement</span></label>
        <input type='text' name='EnphaseSerial' id='EnphaseSerial' onchange='checkDisabled();'>
      </div>
      <div class='ligne' id="ligneShellyEmPhases">
        <label for='ShellyEmPhases'>Monophasé : Numéro de voie (0 ou 1) mesurant l'entrée du courant maison<br>Triphasé : mettre 3</label>
        <input type='text' name='ShellyEmPhases' id='ShellyEmPhases' onchange='checkDisabled();'>
      </div>
      <br>
